...
from dp_detector.common.defines import IS_DEBUG
...
from dp_detector.common.processing_parameters.map_processing_parameters import MapProcessingParameters, \
    ProcessedAreaType
from dp_detector.processing import processing_utils, extent_utils
from dp_detector.processing.map_processor.map_processing_result import MapProcessingResult, \
...
class MapProcessor(QgsTask):
    ...
    Objects of this class are created and managed by the 'dp_detector'.
